...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.contact-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                html: `Record contact attempt for <strong style="color:#19d3ff;">${decodedUsername}</strong>:<br><br>`,
                icon: 'info',
                input: 'textarea',
    ...
    document.querySelectorAll('.approve-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            Swal.fire({
                title: 'Approve User?',
                html: `Are you sure you want to approve <strong style="color:#19d3ff;">${decodedUsername}</strong>?<br><br>They will be able to access their account immediately.`,
                icon: 'question',
                showCancelButton: true,
    ...
    document.querySelectorAll('.admin-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            Swal.fire({
                title: 'Mark as Admin?',
                html: `Are you sure you want to mark <strong style="color:#19d3ff;">${decodedUsername}</strong> as an administrator?<br><br><strong>This will:</strong><br>• Automatically approve their account<br>• Grant full admin privileges<br>• Allow them to manage other users`,
                icon: 'warning',
                showCancelButton: true,
    ...
    document.querySelectorAll('.make-admin-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            Swal.fire({
                title: 'Make Admin?',
                html: `Are you sure you want to make <strong style="color:#19d3ff;">${decodedUsername}</strong> an administrator?<br><br><strong>This will grant them:</strong><br>• Full admin privileges<br>• Ability to manage other users<br>• Access to admin-only features`,
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3e8ed0',
                cancelButtonColor: '#dbdbdb',
    ...
    document.querySelectorAll('.remove-admin-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                html: `Are you sure you want to remove admin privileges from <strong style="color:#19d3ff;">${decodedUsername}</strong>?<br><br><strong>This will:</strong><br>• Remove all admin privileges<br>• Restrict access to admin features<br>• Convert them to a regular user`,
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#ffdd57',
                cancelButtonColor: '#dbdbdb',
    ...
    document.querySelectorAll('.reject-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            Swal.fire({
                title: 'Reject User?',
                html: `Are you sure you want to reject <strong style="color:#19d3ff;">${decodedUsername}</strong>?<br><br>Please provide a reason for rejection:`,
                icon: 'warning',
                input: 'textarea',
    ...
    document.querySelectorAll('.verify-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            Swal.fire({
                title: 'Verify User?',
                html: `Are you sure you want to verify <strong style="color:#19d3ff;">${decodedUsername}</strong>?<br><br>This will mark their account as verified and trusted.`,
                icon: 'question',
                showCancelButton: true,
                confirmButtonColor: '#48c78e',
                cancelButtonColor: '#dbdbdb',
    ...
    document.querySelectorAll('.deactivate-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                html: `Are you sure you want to deactivate <strong style="color:#19d3ff;">${decodedUsername}</strong>?<br><br>Please provide a reason for deactivation:`,
                icon: 'warning',
                input: 'textarea',
    ...
    document.querySelectorAll('.suspend-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            Swal.fire({
                title: 'Suspend User?',
                html: `Are you sure you want to suspend <strong style="color:#19d3ff;">${decodedUsername}</strong>?<br><br>Please provide a reason for suspension:`,
                icon: 'warning',
                input: 'textarea',
    ...
    document.querySelectorAll('.unsuspend-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                html: `Are you sure you want to unsuspend <strong style="color:#19d3ff;">${decodedUsername}</strong>?<br><br>They will be able to access their account immediately.`,
                icon: 'question',
                showCancelButton: true,
                confirmButtonColor: '#48c78e',
                cancelButtonColor: '#dbdbdb',
    ...
    document.querySelectorAll('.edit-email-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                html: `Update public email for <strong style="color:#19d3ff;">${decodedUsername}</strong>:<br><br>`,
                icon: 'info',
                input: 'email',
