...
<div class="content">
    ...
    <nav class="breadcrumb has-arrow-separator" aria-label="breadcrumbs" style="margin-bottom: 20px;">
        <ul>
            ...
            <li class="is-active"><a href="#" aria-current="page"><span class="icon is-small"><i class="fas fa-envelope"></i></span><span>Messages</span></a></li>
        </ul>
    </nav>
                    ...
                    <div class="level-left">
                        <div>
                            ...
                            <p class="subtitle is-6">
                                From: <strong><?= $currentMessage['created_by_display_name'] === 'admin' ? 'Aetia Talent Agency' : htmlspecialchars($currentMessage['created_by_display_name']) ?></strong>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function createMessageHTML(item) {
        ...
        const profileImage = item.profile_image ? 
            `<img src="${item.profile_image}" alt="Profile Picture" class="profile-image">` :
    ...
    const { value: formValues } = await Swal.fire({
        ...
        html: `
            <div class="field">
                ...
                <div class="control">
                    <input id="swal-subject" class="input swal-light-input" type="text" placeholder="Enter message subject">
                </div>
            </div>
            <div class="field">
