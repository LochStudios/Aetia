    ...
    <?php if ($user['username'] === 'admin' && $user['approved_by'] === 'Auto-Generated' && !isset($_SESSION['admin_setup_complete'])): ?>
        <div class="notification is-warning is-dark has-text-white mb-4">
            <div class="content">
                ...
                <p>You are logged in with the auto-generated admin account. For security purposes, please change your
                    password immediately.</p>
                <p>Consider creating a personalized admin account and disabling this default account after setup is
                    complete.</p>
            </div>
        </div>
    <?php endif; ?>
                            ...
                            <?php if ($user['profile_image']): ?>
                                <?php if ($user['account_type'] === 'manual'): ?>
                                    ...
                                    <img id="profile-image-display"
                                        src="api/view-profile-image.php?user_id=<?= $_SESSION['user_id'] ?>"
                            ...
                            <?php if ($user['account_type'] === 'manual'): ?>
                                ...
                                <div class="profile-image-upload">
                                    <?php if ($user['profile_image']): ?>
                                        ...
                                        <button class="button is-small is-info mb-2"
                                    ...
                                    <?php endif; ?>
                                    <!-- Hidden File Input -->
                                    <form id="imageUploadForm" method="POST" action="profile.php"
                                        enctype="multipart/form-data" style="display:none;">
                                        <input type="hidden" name="action" value="upload_image">
                                        <input type="file" id="imageUploadInput" name="profile_image"
                    ...
                    <div class="card-content">
                        ...
                        <div class="columns is-mobile mb-3">
                            ...
                            <div class="column has-text-centered">
                                ...
                                <p class="title is-5 has-text-success mb-0">$<?= number_format($currentMonthBilling, 2) ?>
                                </p>
                            </div>
                        </div>
                        ...
                        <div id="activity-breakdown" style="display: none;">
                            ...
                            <div class="content">
                                <?php foreach (array_reverse($yearlyBillingData) as $monthData): ?>
                                    <div class="level is-mobile mb-2 has-background-grey-darker"
                                        ...
                                        <div class="level-right">
                                            <div class="level-item">
                                                <div class="has-text-right">
                                                    <p class="has-text-success is-size-7 has-text-weight-bold mb-0">
                                                        $<?= number_format($monthData['total_fee'], 2) ?></p>
                                                    <p class="has-text-grey-light is-size-7"><?= $monthData['message_count'] ?>
                                                        messages</p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="level is-mobile mt-3 pt-3" style="border-top: 1px solid #4a4a4a;">
                                    ...
                                    <div class="level-right">
                                        <div class="level-item">
                                            <div class="has-text-right">
                                                <p class="has-text-success is-size-6 has-text-weight-bold mb-0">
                                                    $<?= number_format($totalYearBilling, 2) ?></p>
                                                <p class="has-text-grey-light is-size-7"><?= $totalYearMessages ?> messages
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="card has-background-dark mt-4">
                    <div class="card-content">
                        ...
                        <div class="notification is-warning is-dark has-text-white">
                            ...
                            <p class="has-text-dark is-size-7">Your activity summary will be available once your account is
                            ...
                            <div class="mb-3" style="background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 6px;">
                                <div class="level is-mobile">
                                    <div class="level-left">
                                        <div class="level-item">
                                            <span
                                                class="icon has-text-<?= $connection['platform'] === 'twitch' ? 'primary' : ($connection['platform'] === 'discord' ? 'info' : ($connection['platform'] === 'youtube' ? 'danger' : 'warning')) ?>">
                                                ...
                                                <p class="is-size-7 has-text-light">
                                                    ...
                                                    <?php if ($connection['is_primary']): ?>
                                                        <span class="tag is-primary is-small ml-1"
                                                            style="font-size: 0.6rem; padding: 2px 6px;">Primary</span>
                                                    <?php endif; ?>
                                                </p>
                                                <p class="is-size-7 has-text-grey-light sensitive-info" style="display: none;">
                                                    @<?= htmlspecialchars($connection['social_username']) ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="level-right">
                ...
                <div class="card-content">
                    ...
                    <form method="POST" action="profile.php">
                        ...
                        <input type="hidden" name="csrf_token"
                            value="<?= htmlspecialchars($securityManager->getCsrfToken()) ?>">
                        <!-- SMS Enable/Disable -->
                        <div class="field">
                            <div class="control">
                        ...
                        <div id="sms-fields" style="<?= $smsEnabled ? '' : 'display: none;' ?>">
                            <div class="field sensitive-info" style="display: none;">
                                ...
                                <?php
                                // Parse existing phone number to determine country code and local number
                                $currentCountryCode = '+61'; // Default to Australia
                                $currentPhoneNumber = '';
                                if (!empty($phoneNumber)) {
                                    if (strpos($phoneNumber, '+1') === 0 && strlen($phoneNumber) === 12) {
                                    ...
                                    } elseif (strpos($phoneNumber, '+64') === 0) {
                                        $currentCountryCode = '+64';
                                        $currentPhoneNumber = substr($phoneNumber, 3);
                                    } else {
                                    ...
                                    <div class="control">
                                        <div class="select">
                                            <select name="country_code" id="country_code_select"
                                                ...
                                                style="border-color: #4a4a4a; background-color: #363636; color: #f5f5f5;"
                                                onchange="updatePhonePlaceholder()">
                                                <option value="+61" <?= $currentCountryCode === '+61' ? 'selected' : '' ?>>
                                                    🇦🇺 +61 (Australia)</option>
                                                <option value="+64" <?= $currentCountryCode === '+64' ? 'selected' : '' ?>>
                                                    🇳🇿 +64 (New Zealand)</option>
                                                <option value="+1" <?= $currentCountryCode === '+1' ? 'selected' : '' ?>>
                                                    🇺🇸 +1 (USA)</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="control is-expanded has-icons-left">
                                        <input class="input has-background-grey-darker has-text-light" type="tel"
                                            name="phone_number_local" id="phone_number_local_input"
                                            placeholder="e.g., 411234567"
                                            value="<?= htmlspecialchars($currentPhoneNumber) ?>" pattern="\d{7,14}"
                                ...
                                <p class="help has-text-grey-light">
                                    ...
                                    <br><span class="has-text-info" id="phone-example-hint"><i
                                            class="fas fa-info-circle"></i> Example: For Australia: 411234567
                                        &nbsp;|&nbsp; NZ: 211234567 &nbsp;|&nbsp; USA: 5551234567</span>
                                </p>
                                <!-- Hidden field to combine country code and phone number -->
                                <input type="hidden" name="phone_number" id="combined_phone_number"
                    ...
                    <?php if ($smsEnabled && $phoneNumber && !$phoneVerified): ?>
                        ...
                        <div class="notification is-warning is-dark has-text-white mb-4">
                            <div class="content">
                                <p><strong>Phone Verification Required:</strong> Please verify your phone number to enable
                                    SMS notifications.</p>
                                <div class="notification is-info is-dark has-text-white mt-3"
                                    style="background-color: rgba(50, 115, 220, 0.2); border-left: 4px solid #3273dc;">
                                    ...
                                    <p class="is-size-7 mt-2"><em>Future SMS notifications will be charged at $0.30 per
                                            message only.</em></p>
                                </div>
                            </div>
                        </div>
                        <div class="field">
                            <form method="POST" action="profile.php" style="display: inline;">
                                ...
                                <input type="hidden" name="csrf_token"
                                    value="<?= htmlspecialchars($securityManager->getCsrfToken()) ?>">
                                <button class="button is-info" type="submit" id="send-verification-btn"
                                    onclick="showVerificationField(event)">
                            ...
                            <form method="POST" action="profile.php">
                                ...
                                <div class="field has-addons">
                                    <div class="control is-expanded">
                                        <input class="input has-background-grey-darker has-text-light" type="text"
                                            name="verification_code" placeholder="Enter 6-digit code" maxlength="6"
        ...
        <div class="column is-8">
            <div class="card has-background-dark">
                <div class="card-content">
                    <div class="level is-mobile mb-4">
                        ...
                        <div class="level-right">
                            <div class="level-item">
                                <button class="button is-small is-info" onclick="toggleSensitiveInfo()"
                    ...
                    <div class="field sensitive-info" style="display: none;">
                        ...
                        <div class="control">
                            <input class="input has-background-grey-darker has-text-light" type="email"
                    ...
                    <div class="field">
                        <label class="label has-text-light">
                            ...
                            <span class="icon has-text-info"
                                title="This is your public email address for client contact">
                        ...
                        <div class="field has-addons">
                            <div class="control is-expanded">
                                ...
                                ?>
                                <input class="input has-background-grey-darker has-text-light" type="email"
                                    value="<?= htmlspecialchars($publicEmail) ?>" readonly id="publicEmail">
                            </div>
                            <div class="control">
                                <button class="button has-background-grey-darker has-text-light" type="button"
                                    onclick="copyPublicEmail()" title="Click to copy email">
                                    <span class="icon">
                        ...
                        <p class="help has-text-grey-light">
                            <?php if ($user['approval_status'] === 'approved'): ?>
                                <?php if ($isCustomEmail): ?>
                                    ...
                                    <br><span class="has-text-info"><i class="fas fa-star"></i> Custom email address assigned by
                                        our talent team</span>
                                <?php else: ?>
                                    This is your professional email address that clients can use to contact you directly.
                                    <br><span class="has-text-grey-lighter">You can request this to be changed to something that
                                        fits your brand by messaging our talent team directly via the <a href="messages.php"
                                            class="has-text-info">Messages</a> page.</span>
                                <?php endif; ?>
                            <?php else: ?>
                                <span class="has-text-warning"><i class="fas fa-clock"></i> When you're approved and part of
                                    our team, this will be your professional email address that you can make public.</span>
                                <?php if (!$isCustomEmail): ?>
                                    <br><span class="has-text-grey-lighter">You can always request this to be changed to
                                        something that fits your brand once approved via the <a href="messages.php"
                                            class="has-text-info">Messages</a> page.</span>
                                <?php endif; ?>
                            <?php endif; ?>
                        </p>
                ...
                <div class="card has-background-dark mt-4">
                    <div class="card-content">
                        ...
                        <div class="notification is-info mb-4">
                            <div class="content">
                                <p class="hast-text-black"><strong>Complete Your Profile:</strong> Please provide your first
                                    and last name to complete your profile.</p>
                                <p class="hast-text-black">This information helps us personalize your experience and improve
                                    our services.</p>
                            </div>
                        </div>
                        <form method="POST" action="profile.php">
                            ...
                            <div class="field">
                                ...
                                <div class="control has-icons-left">
                                    <input class="input has-background-grey-darker has-text-light" type="text"
                                        ...
                                        value="<?= htmlspecialchars($user['first_name'] ?? '') ?>" maxlength="50"
                            ...
                            <div class="field">
                                ...
                                <div class="control has-icons-left">
                                    <input class="input has-background-grey-darker has-text-light" type="text"
                                        ...
                                        value="<?= htmlspecialchars($user['last_name'] ?? '') ?>" maxlength="50"
                        ...
                        <div id="password-change-form" style="display: none; margin-top: 1rem;">
                            ...
                            <form method="POST" action="profile.php">
                                ...
                                <div class="field">
                                    ...
                                    <div class="control has-icons-left">
                                        <input class="input has-background-grey-darker has-text-light" type="password"
                                ...
                                <div class="field">
                                    ...
                                    <div class="control has-icons-left">
                                        <input class="input has-background-grey-darker has-text-light" type="password"
                                            name="new_password" placeholder="Enter new password" minlength="8" required>
                                        <span class="icon is-small is-left">
            ...
            <?php if ($user['account_type'] !== 'manual' && empty($user['password_hash'])): ?>
                <div class="card has-background-dark mt-4">
                    <div class="card-content">
                        ...
                        <div class="notification is-info is-dark has-text-white mb-4">
                            <div class="content">
                                <p><strong>Enable Manual Login:</strong> Set a password to login with your username and
                                    password in addition to your social accounts.</p>
                                <p>This gives you an alternative way to access your account and is recommended for security.
                                </p>
                        ...
                        <form method="POST" action="profile.php">
                            ...
                            <div class="field">
                                ...
                                <div class="control has-icons-left">
                                    <input class="input has-background-grey-darker has-text-light" type="password"
                                        name="confirm_password" placeholder="Confirm new password" minlength="8" required>
                                    <span class="icon is-small is-left">
                                        <i class="fas fa-key"></i>
                                    </span>
                                </div>
            ...
            <div class="card has-background-dark mt-4">
                <div class="card-content">
                    ...
                    <div class="notification is-info is-dark has-text-white mb-4">
                        <div class="content">
                            <p><strong>Link Multiple Accounts:</strong> You can connect accounts from different
                                platforms even if they use different email addresses.</p>
                            <p>This allows you to access your account through any of your connected social platforms.
                            </p>
                        </div>
                    </div>
                    <div class="buttons">
...
<script>
    ...
    function combinePhoneNumber() {
        ...
        if (localNumber.trim()) {
            combinedField.value = countryCode + localNumber.replace(/\D/g, '');
        } else {
            combinedField.value = '';
        }
    }
    ...
    function updatePhonePlaceholder() {
        ...
        if (hintEl) hintEl.innerHTML = '<i class="fas fa-info-circle"></i> Example: ' + chosen.hint;
        combinePhoneNumber();
    }
