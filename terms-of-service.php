...
ob_start();
?>
<section id="tos-top" class="section">
    <div class="container">
        <div class="columns">
            <div class="column is-8">
                <div class="box legal-content content">
                    ...
                    <p class="has-text-right mt-4"><a href="#tos-top" class="button is-small is-light">Back to top</a></p>
                </div>
            </div>
            <div class="column is-4 is-hidden-mobile">
                <nav id="legal-toc" class="panel legal-toc">
                    <p class="panel-heading">On this page</p>
                </nav>
            </div>
        </div>
    </div>
</section>
<?php $content = ob_get_clean(); ob_clean(); ?>
<script>
    (function() {
        ...
        headings.forEach(h => {
            const text = h.textContent.trim().replace(/^\d+\.\s*/, '');
