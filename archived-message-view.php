...
// Get the archived message with access control
...
$pageTitle = 'Archived Message: ' . htmlspecialchars($currentMessage['subject']);
ob_start();
?>
...
<div class="container">
    ...
    <div class="archive-info">
        ...
        <div class="columns">
            ...
            <div class="column is-full">
                <strong>Reason:</strong> <?= nl2br(htmlspecialchars($currentMessage['archive_reason'])) ?>
            </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="box">
        ...
        <div class="notification is-warning is-light">
            ...
            No further responses can be added to this conversation.
        </div>
